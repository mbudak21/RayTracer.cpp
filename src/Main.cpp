...
RayTracer* initTracer(int width, int height) {
	...
	auto s2 = std::make_shared<Sphere>(Vec3f(-15.0f, 1.0f, -35.0f), 1.5f, MaterialDefaults::FlatWhite);
	...
	auto s10 = std::make_shared<Sphere>(Vec3f(9.0f, 1.0f, -35.0f), 1.5f, MaterialDefaults::BlackPlastic);
